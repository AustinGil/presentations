...
(Based on **automated** WCAG metrics)
...
# Linters - ESLint ([eslint.org](https://eslint.org/))

<div class="grid grid-cols-2">
<v-clicks>
<div>

Code analysis (red squigglies) = 😍
...
# Pre-commit hooks
## Check (& fix) code before every commit
...
Similar to browser extensions. Can highlight and scroll to errors.
